...
export async function fetchPrograms() {
  const { data, error } = await supabase
    .from("programs")
    .select("*, species(id, accepted_name, iucn_status, family, thumbnail_url, composite_score), created_by_researcher:researchers!programs_created_by_fkey(id, name, institution)")
