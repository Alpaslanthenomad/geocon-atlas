...
import SpeciesModuleComp  from “../components/species/SpeciesModule”;

// Admin
import AdminPanelComp from “../components/admin/AdminPanel”;
...
{tab===“info”&&<div style={{display:“grid”,gridTemplateColumns:“1fr 1fr”,gap:“10px 16px”}}>{[{l:“ID”,v:species.id},{l:“Genus”,v:species.genus},{l:“Family”,v:species.family},{l:“Geophyte type”,v:species.geophyte_type},{l:“Region”,v:species.region},{l:“Country”,v:species.country_focus},{l:“TC status”,v:species.tc_status},{l:“Decision”,v:species.current_decision||species.decision},{l:“Market area”,v:species.market_area}].map(({l,v})=>v?<div key={l}><div style={{fontSize:9,color:”#b4b2a9”,textTransform:“uppercase”,letterSpacing:0.4}}>{l}</div><div style={{fontSize:12,color:”#2c2c2a”,fontWeight:500}}>{v}</div></div>:null)}</div>}
</>}
</div>
</div>
</>;
...
```
  ...
  <div style={{ flex:1, minWidth:0, padding:"16px 20px 28px", overflow:"auto" }}>
    ...
    {view === "species"      && <SpeciesModuleComp species={species} onSpeciesClick={setDetailSpecies} />}
    ...
    {view === "admin" && user.role === "admin" && <AdminPanelComp species={species} programs={programs} onDataChange={() => window.location.reload()} />}
