...
//
// The Cambium layer — its own dedicated page inside ExchangeShell. With 0 real
// ventures it shows the honest empty state (an un-grown evidence seed) beside a
// clearly-labelled EXAMPLE cross-section + a how-to-read legend. When real
// ventures exist, the empty seed is replaced by the live Grove (one Cambium per
// venture). No fabricated traction.
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 18 }}>
        ...
        <div style={{ padding: "18px", borderRadius: 16, background: "rgba(20,8,33,0.5)", border: "1px dashed rgba(245,166,35,0.45)", textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12.5, color: "#C8B89E", lineHeight: 1.6, marginTop: 10 }}>
            Fikir → tohum-öncesi → tohum'u tamamlamış, şu an <strong>Seri A</strong>'da canlı büyüyen örnek bir girişim. İki yatırımcı ışını bağlı. Sayılar illüstratiftir.
          </div>
        </div>
      </div>
      ...
      <div style={{ marginTop: 20, display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 18 }}>
        ...
        <div style={{ padding: "16px 20px", borderRadius: 14, background: "rgba(125,168,111,0.08)", border: "1px solid rgba(125,168,111,0.28)" }}>
          ...
          <div style={{ fontSize: 11, color: "#C8B89E", marginTop: 10, lineHeight: 1.5 }}>
            Yarıçap = evre, açı = o evrede geçen süre. Değer yeşil kanıttan <strong>dışa</strong> büyür; firewall geometride.
          </div>
        </div>
      </div>
    </ExchangeShell>
