...
export default function ProgramCockpit({ programId, lang = "tr", onGoToTab, showActivity = false, compact = false, onResolveActiveTab }) {
  ...
  const STUDIOS = [
    { label: lang === "tr" ? "Teknik Çeviri Sınırı" : "Translation Boundary", hint: lang === "tr" ? "GEOCON sinyalini DeepTech Translation Case'e hazırla" : "Prepare the GEOCON signal for a DeepTech Translation Case", href: `/geocon/programs/${programId}/deeptech` },
