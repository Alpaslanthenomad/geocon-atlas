...
{families.map(f => <FamilyCard key={f} family={f} species={species} isSelected={selectedFamily===f} onSelect={onSelectFamily} />)}
</div>
</>;
}
...
<button onClick={onBack} style={{ padding:“6px 12px”, border:“1px solid #e8e6e1”, borderRadius:7, background:”#fff”, cursor:“pointer”, fontSize:11, color:”#888” }}>← Families</button>
<div style={{ flex:1 }}>
